...
- If the guess is correct, we use the **PLAY** action to play a short sound of victory and then congratulate the user before ending the call and deleting the caller's instance from our `cache` variable.
